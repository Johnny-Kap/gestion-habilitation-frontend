...
@Component({
  selector: 'app-editformapplication',
  templateUrl: './editformapplication.component.html',
  styleUrls: ['./editformapplication.component.css'],
  standalone: false
})
export class EditformapplicationComponent implements OnInit {
  formValue!: FormGroup;
  ...
  postUpdatesapplication(info){
    this.api.updateApplication(info,info.appId)
    .subscribe(res=>{
