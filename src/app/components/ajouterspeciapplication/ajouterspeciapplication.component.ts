...
@Component({
  selector: 'app-ajouterspeciapplication',
  templateUrl: './ajouterspeciapplication.component.html',
  styleUrls: ['./ajouterspeciapplication.component.css'],
  standalone: false
})
export class AjouterspeciapplicationComponent implements OnInit {
 ...
 this.getAllapplication();
  ...
  postApplication(info){
    ...
    this.api.postapplication(this.info)
    .subscribe(res => {
      // TODO: Remplacer par la nouvelle méthode de notification
